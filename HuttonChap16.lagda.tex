...
\begin{code}
open import Haskell.Law.Functor.Def using (IsLawfulFunctor; identity; composition)
open import Haskell.Prim.Maybe using (Maybe)

instance
  ILawfulFunctorMaybe : IsLawfulFunctor Maybe
  identity ⦃ ILawfulFunctorMaybe ⦄ Nothing = refl
  identity ⦃ ILawfulFunctorMaybe ⦄ (Just x) = refl
  composition ⦃ ILawfulFunctorMaybe ⦄ Nothing f g = refl
  composition ⦃ ILawfulFunctorMaybe ⦄ (Just x) f g = refl
\end{code}
